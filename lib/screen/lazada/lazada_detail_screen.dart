...
class _LazadaDetailOrderScreenState extends State<LazadaDetailOrderScreen> {
  @override
  void initState() {
    context.read<PlatformBloc>().add(PlatformSingleOrder(widget.orderId));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<PlatformBloc, PlatformState>(builder: (context, state) {
        if (state is LoadingSingle) {
          const LoadingScreen();
        }
              ...
              child: ListView(
                ...
                children: [
                  ListTile(
                    ...
                    title: Text('Resi : ${state.order.trackingNumber ?? ""}'),
                    subtitle: Column(
