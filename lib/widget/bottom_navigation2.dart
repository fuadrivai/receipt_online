...
import 'package:receipt_online_shop/widget/tabicon_data.dart';
...
class BottomNavigation2State extends State<BottomNavigation2>
  ...
  void initState() {
    ...
    tabBody = HomeScreen2(animationController: animationController);
    super.initState();
  }
  ...
  changeIndex(int index) {
    if (index == 0 || index == 2) {
      ...
      animationController?.reverse().then<dynamic>((data) {
        ...
        setState(() {
          tabBody = const ProductCheckerScreen();
        });
      });
    }
  }
